#!/usr/bin/env python
"""
Reset all categories and create main category structure.

Main Categories:
1. Pişirme Ekipmanları (pisirme-ekipmanlari)
2. Fırınlar (firinlar)
3. Soğutma Üniteleri (sogutma-uniteleri)
4. Hazırlık Ekipmanları (hazirlik-ekipmanlari)
5. Kafeterya Ekipmanları (kafeterya-ekipmanlari)
6. Çamaşırhane (camasirhane)
7. Tamamlayıcı Ekipmanlar (tamamlayici-ekipmanlar)
8. Bulaşıkhane (bulasıkhane)
"""
...
# Setup Django - add backend to path
...
def main():
    ...
    print()
    print("To add subcategories, products, etc., create additional scripts")
    print("or use the Django admin panel.")
    print()
