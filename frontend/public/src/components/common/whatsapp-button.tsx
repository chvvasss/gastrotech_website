...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed z-30 flex items-center no-underline right-4 bottom-[88px] sm:right-0 sm:bottom-auto sm:top-1/2"
    ...
    >
      <motion.div
        className="flex items-center h-12 bg-[#25D366] text-white shadow-lg shadow-[#25D366]/25 overflow-hidden cursor-pointer rounded-full sm:rounded-l-sm sm:rounded-r-none"
        animate={{
