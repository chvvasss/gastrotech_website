...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed z-30 flex items-center no-underline right-0 bottom-[68px]"
    ...
    >
      <motion.div
        className="flex items-center h-12 bg-[#25D366] text-white shadow-lg shadow-[#25D366]/25 overflow-hidden cursor-pointer rounded-l-sm rounded-r-none"
        animate={{
